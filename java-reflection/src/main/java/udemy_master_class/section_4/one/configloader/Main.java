package udemy_master_class.section_4.one.configloader;
...
import udemy_master_class.section_4.one.data.GameConfig;
import udemy_master_class.section_4.one.data.UserInterfaceConfig;

public class Main {

    private static final Path GAME_CONFIG_PATH = Path.of("java-reflection/src/main/resources/game-properties.cfg");
    private static final Path UI_CONFIG_PATH = Path.of("java-reflection/src/main/resources/user-interface.cfg");
    ...
    public static void main(String[] args)
        ...
        UserInterfaceConfig configObject1 = createConfigObject(UserInterfaceConfig.class, UI_CONFIG_PATH);
        System.out.println(configObject1);
    }

    public static <T> T createConfigObject(Class<T> clazz, Path fiePath)
            throws IOException, NoSuchMethodException, InvocationTargetException, InstantiationException,
            IllegalAccessException {

        Scanner scanner = new Scanner(fiePath);
